...
public class DijkstraSingleThread extends Thread {
    ...
    public DijkstraSingleThread.Graph graph;

    public DijkstraSingleThread(String[] inputsets, DijkstraSingleThread.Graph graph, int processors){
        this.graph = graph;
    }
    ...
    public void run(){
        ...
        long beginNanoTime = System.nanoTime();
            try{
                ...
                System.out.println("Graph " + graph.getInputsetName() + " ran in " + totalDuration + " ns.");
            }
        }
    ...
    static class Graph extends Thread {

        String inputsetName;
        int vertices;
        int sourceVertex;
        LinkedList<Edge>[] adjacencylist;
        Integer [] newDistances;


        public Integer[] getNewDistances() {
            return newDistances;
        }

        public void setNewDistances(Integer[] newDistances) {
            this.newDistances = newDistances;
        }

        Graph(String inputsetName, int sourceVertex, int vertices) {
        ...
        public void printDijkstra(int[] distance, int sourceVertex){
            ...
            for (int i = 0; i <vertices ; i++) {
                System.out.println("Source Vertex: " + sourceVertex + " to vertex " +   + i +
                        " distance: " + distance[i]);
                System.out.println("Single Thread with vertex var");
            }
        }
