...
import nl.hva.dmci.ict.sortingsearching.weigthedgraph.EdgeWeightedDirectedCycle;
 ...
 */ 
    ...
    private int aantalKnopenOnderzocht = 0;

    public int getAantalKnopenOnderzocht() {
		return aantalKnopenOnderzocht;
	}
    ...
    public FloydWarshall(AdjMatrixEdgeWeightedDigraph G) {
        ...
        for (int i = 0; i < V; i++) {
            ...
            for (int v = 0; v < V; v++) {
                ...
                for (int w = 0; w < V; w++) {
                	aantalKnopenOnderzocht = aantalKnopenOnderzocht + 2;
